mplement weather modeling* using the quadratic solution in stages: hard-coding variables keyboard input, read from a file, for a single set of input, multiple sets of inputs. a. save all versions, debug, fix problems, create a GitHub account
...
if discriminant > 0:
    ...
    return None
def solve_weather_equation(a, b, c): solutions = quadratic_solver(a, b, c) return solutions

def plot_weather_model(a, b, c): # Calculate the discriminant discriminant = b**2 - 4ac
